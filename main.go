...
import (
	...
	_ "github.com/yrong/forecast/backends"
	_ "github.com/yrong/forecast/frontends"
	"github.com/yrong/forecast/iface"
)
...
func main() {
	...
	location := flag.String("location", "32.0616667,118.7777778", "`LOCATION` to be queried")
	flag.StringVar(location, "l", "32.0616667,118.7777778", "`LOCATION` to be queried (shorthand)")
	...
	if err := ingo.Parse("forecast"); err != nil {
